...
# క్రికెట్ డేటా
data = {
    'ప్లేయర్ పేరు': ['Virat Kohli', 'keerthan reddy', 'Rohit Sharma', 'Sachin Tendulkar'],
    'మ్యాచ్‌లు': [295, 350, 262, 463],
    'రన్స్': [13848, 10773, 10709, 18426],
    'సంచరీలు (100s)': [50, 10, 31, 49],
    'సగటు (Average)': [58.6, 50.5, 49.1, 44.8]}
